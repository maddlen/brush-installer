...
async function main() {
    ...
    if (whatToInstall === "gadget") {
        const installSpinner = (0, ora_1.default)("Adding requried Node module with Yarn...").start();
        await (0, execa_1.execa)("yarn", ["add", "@shopify/admin-api-client", "@shopify/storefront-api-client", "zod", "json5"], { stdio: "inherit" });
